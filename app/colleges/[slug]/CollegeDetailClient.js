...
const COLLEGE_DATA = {
  ...
  'iim-bangalore': {
    ...
    campusLabel: 'Bannerghatta Road campus · Lush green 100-acre campus · Bengaluru tech hub',
    color: '#C0392B',
    emoji: '🎓',
    tagline: "India's #2 MBA and the best B-school for technology, product management and consulting in Bangalore. IIM B's location in India's startup and tech capital gives it an edge no other IIM can match.",
    nirf: 2,
    qs: 52,
    ft: 34,
    bt: 1,
    ...
    stats: [
      { label: 'Avg Package', value: 'Rs 34.88 LPA', sub: '2025 placement report' },
      { label: 'Median Package', value: 'Rs 32.61 LPA', sub: 'PGP + PGPBA 2023-25' },
      { label: 'Total Fees', value: 'Rs 26 L', sub: 'PGP 2025-27 batch' },
      { label: 'Overseas Offers', value: '22', sub: 'international placements' },
      { label: 'CAT Cutoff', value: '98%ile+', sub: 'General category realistic' },
      { label: 'Batch Size', value: '544', sub: 'PGP 2025 enrolled' },
    ],
    ...
    fees: {
      ...
      other: 4.00,
      total: 26.00,
      living_monthly: 'Rs 10,000 – 20,000',
      loan_max: 'Rs 20-30 L',
      loan_rate: '8-10% p.a.',
      scholarships: [
        { name: 'Financial Aid (Need-Based)', criteria: 'Family income below Rs 8 LPA', amount: '20%-100% of fees' },
        { name: 'Aditya Birla Scholarship', criteria: 'Top performers Year 1 and 2', amount: 'Rs 1.75 lakhs per student' },
        { name: 'NTPC Scholarship', criteria: 'SC/ST/PwD Year 2 students', amount: 'Rs 48,000 per year' },
        { name: 'Ministry of Tribal Affairs (ST)', criteria: 'ST category Year 1', amount: 'Full tuition' },
        { name: 'Ministry of Social Justice (SC)', criteria: 'Meritorious SC students Year 1', amount: 'Full tuition' },
        { name: 'Employment in Social Sector', criteria: 'Students who join social sector', amount: 'One-third fees reimbursed per year for 3 years' },
      ],
    },
    ...
    admissions: {
      ...
      final_weights: [
        ...
        { label: 'Academics (10th + 12th + Graduation)', pct: 15 },
    ...
    programs: [
      { name: 'PGP (MBA)', duration: '2 years', fees: 'Rs 26 L', intake: 480, exam: 'CAT', note: 'Flagship 2-year residential MBA programme' },
      { name: 'PGPBA (Business Analytics)', duration: '2 years', fees: 'Rs 26 L', intake: 64, exam: 'CAT', note: 'Analytics-focused MBA, joint placements with PGP' },
      { name: 'EPGP (Executive MBA)', duration: '1 year', fees: 'Rs 35 L (est.)', intake: 82, exam: 'GMAT/CAT', note: 'Min 5 years work exp; FT ranked #34 globally' },
      { name: 'PGPEM (Enterprise Mgmt)', duration: '2 years', fees: 'Rs 35 L (est.)', intake: null, exam: 'GMAT', note: 'Part-time executive programme for working professionals' },
    ...
    rankings: [
      ...
      { source: 'Bloomberg 2025', rank: '#3 APAC', note: '1-year MBA ranked #1 in India' },
    ...
    campus: {
      ...
      dorms: null,
      dorm_capacity: null,
      architect: 'Designed in 1970s; lush green campus in Bengaluru',
      heritage: 'Located in Silicon Valley of India',
      clubs: 50,
      highlights: [
        'Located in Bengaluru — India's startup and technology capital',
        '95 international partner institutions across 30 countries',
        '200+ MBA students go on exchange annually to 50 partner universities',
        'Only Indian B-school in Global Network for Advanced Management (Yale)',
        'Israel Centre, Mizuho India Japan Study Centre, dedicated research hubs',
        '140+ faculty from universities and industries worldwide',
        'NSRCEL — one of India's top startup incubators on campus',
        'Students can opt to live off-campus in Year 2 — unique flexibility',
      ],
    },

    alumni: [
      { name: 'Nandan Nilekani', batch: 1978, role: 'Co-founder, Infosys; Architect of Aadhaar; Padma Bhushan' },
      { name: 'Kiran Mazumdar-Shaw', batch: null, role: 'Founder, Biocon; Padma Bhushan; Pioneering biopharmaceutical entrepreneur' },
      { name: 'S. D. Shibulal', batch: 1978, role: 'Former CEO, Infosys; Co-founder' },
      { name: 'Rashmi Bansal', batch: null, role: 'Author; Stay Hungry Stay Foolish; Entrepreneurship evangelist' },
      ...
      { name: 'Arun Seth', batch: null, role: 'Former Chairman, British Telecom India' },
      ...
      { name: 'Anand Daniel', batch: null, role: 'Partner, Accel Partners India' },
      { name: 'Sanjay Nayar', batch: null, role: 'Former CEO, KKR India; Founding Partner, Sorin Investments' },
    ],

    verdict: {
      best_for: [
        'Technology and product management — Bengaluru location gives unmatched access to Google, Amazon, Microsoft, Flipkart',
        'Consulting — 41% of batch goes to consulting; Accenture Strategy (75 offers) is largest single recruiter in India',
        'International careers — 22 overseas offers, exchange programmes to 50 universities, Yale GNAM network',
        'Startups and entrepreneurship — NSRCEL incubator on campus, Bengaluru ecosystem, Infosys founders as alumni',
        'Students who want a corporate hub location — Bengaluru offers weekend networking IIM A cannot replicate',
      ],
      watch_out: [
        'Higher cost of living than Ahmedabad — Bengaluru accommodation and expenses are significantly more expensive',
        'Fees of Rs 26L comparable to IIM A but with lower reported median (Rs 32.61L vs Rs 34.53L)',
        'Engineering-heavy batch — 70% engineers; less diversity than IIM A's current 50-50 split',
        'Accenture Strategy dominates with 75 offers — may inflate consulting % without MBB quality equivalent',
        'Financial aid threshold lower than IIM A — family income must be below Rs 8 LPA (vs Rs 15 LPA at IIM A)',
      ],
      apply_if: 'You want technology or product management roles, international placements, or consulting in a city with active corporate networking. Also ideal if you specifically want to be in Bengaluru during your MBA.',
      skip_if: 'You are purely targeting IIM A for FMCG or PE/VC roles where IIM A has a stronger recruiter relationship. Also reconsider if cost of living in Bengaluru is a concern.',
    },
    ...
    reviews: {
      ...
      overall: 4.4,
      quotes: [
        { text: 'The Bengaluru location is a genuine advantage. Every weekend there is something happening in the tech or startup world that you can attend. You cannot get this at any other IIM.', source: 'PGP Alumnus, 2024' },
        { text: 'International exposure at IIM B is real. The exchange programme, 22 overseas placements, and the global faculty network make this feel like a genuinely global institution.', source: 'PGP Alumnus, 2023' },
        { text: 'The city gives you more freedom than IIM A — you can live off-campus in Year 2, explore Bengaluru, and build your own network beyond the campus bubble.', source: 'Current Student, 2025' },
        { text: 'Consulting placements are strong but Accenture Strategy numbers can be misleading. If you want MBB specifically, IIM A still has the edge. IIM B is better for tech and international.', source: 'PGP Alumnus, 2022' },
      ],
    },
  },
}
