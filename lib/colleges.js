...
export const COLLEGES = {
  ...
  'imt-ghaziabad': {
    ...
    nirf: 35, tier: 2, founded: 1980,   // ⚠️ NIRF corrected from 42 → 35 per your IMT core.js
    fees: 2150000,                       // ₹21.5L — corrected from 2095000 per IMT fees.js (tuition + one-time)
    avgPkg: 1815000,                     // ₹18.15 LPA — corrected from 1200000 per IMT 2025 report
    medianPkg: 1700000,                  // ₹17 LPA
    highestDomestic: 3500000,            // ₹35 LPA
    highestIntl: 4617000,                // ₹46.17 LPA
    intake: 480,
    exams: { CAT: 90, XAT: 90, GMAT: 650, NMAT: 200 },  // CAT corrected 88→90 per IMT admissions.js
    sectionalMin: null,
    workExpPreferred: false,
    tags: ['BFSI', 'Consulting', 'IT / ITeS', 'FMCG', 'Marketing', 'Finance'],
    topRecruiters: ['Goldman Sachs', 'D.E. Shaw', 'BlackRock', 'JP Morgan Chase', 'Deloitte', 'Accenture', 'Amazon', 'Microsoft', 'HUL', 'ITC'],
    verdict: 'Best Tier 2 MBA for NCR careers at the 90-93 percentile CAT range. AACSB-accredited, ₹18.15 LPA avg (PGDM 2025), and 160+ companies. Large batch (480-600) is the key risk — top quartile gets excellent outcomes, bottom quartile struggles.',
    pros: ['NCR location — 5 mins from Delhi Metro · corporate access', 'AACSB accreditation — one of the oldest among private B-schools', '₹18.15 LPA avg + ₹46.17 LPA highest international · strong BFSI pipeline (Goldman Sachs, D.E. Shaw)', '98%ile+ scholarship (25-30% waiver) drops fees to ₹15-16L'],
    cons: ['Large batch of 480-600 — competition for top slots is intense', 'Bottom quartile ₹9-12 LPA — significantly below ₹18.15 avg', 'No AMBA accreditation — AACSB only', 'Ghaziabad location — polished but not Gurgaon/Central Delhi'],
    asked: ['IMT vs FORE Delhi — which is better?', 'IMT Ghaziabad placement 2025', 'IMT CAT cutoff for OBC', 'IMT vs TAPMI'],
  },
  ...
  'gim-goa': {
    name: 'Goa Institute of Management', short: 'GIM Goa', slug: 'gim-goa',
    city: 'Sattari', state: 'Goa', emoji: '🌴',
    nirf: 43, tier: 2, founded: 1993,    // NIRF #43 (2025) — slipped from #37 (2024)
    fees: 2145000,                        // ₹21.45L tuition (PGDM all 4 tracks)
    avgPkg: 1513000,                      // ₹15.13 LPA — PGDM General 2025
    medianPkg: 1500000,                   // ₹15 LPA
    highestDomestic: 3220000,             // ₹32.20 LPA — PGDM BDA 2025
    highestIntl: null,
    intake: 780,                          // Total across 4 PGDM tracks + IDA
    exams: { CAT: 88, XAT: 85, CMAT: 95, GMAT: 600 },
    sectionalMin: null,
    workExpPreferred: false,              // Freshers welcome in full-time PGDM
    tags: ['Healthcare', 'Big Data Analytics', 'BIFS', 'Finance', 'Banking', 'Consulting'],
    topRecruiters: ['JP Morgan Chase', 'Goldman Sachs', 'HSBC', 'Deloitte', 'EY', 'Accenture', 'Amazon', 'Optum', 'Cognizant', 'ICICI Bank'],
    verdict: "Specialisation play at 85-90 percentile CAT range — PGDM Healthcare Management, Big Data Analytics, and BIFS are the real draws, not the generalist track. NIRF #43, AMBA (UK) accredited, ₹15.13 LPA avg. Pick GIM for a specific programme, not the general brand — IMT's ₹18.15 LPA at identical ₹21.45L fees is stronger for generalist PGDM candidates.",
    pros: [
      '4 specialised PGDM tracks — General, Healthcare (HCM), Big Data Analytics (BDA), BIFS — rare flexibility',
      'PGDM BDA: ₹32.2 LPA highest + SAS/Azure/Power BI labs + Portugal dual-degree option (Nova School)',
      'PGDM HCM: India\'s first dedicated healthcare MBA — 100% placement, Optum/Novartis recruiters',
      '80 merit scholarships × ₹5L each — effective fees drop to ₹16.45L for ~10% of batch',
      'AMBA (UK) + SAQS + BGA accreditations · NBA-accredited PGDM and HCM',
    ],
    cons: [
      'NIRF slipped from #37 (2024) to #43 (2025) — 6-rank drop in one year',
      'General PGDM avg ₹15.13 LPA vs IMT\'s ₹18.15 LPA at identical fees',
      'Sattari location — 100km from Panaji, 4 hrs from Mumbai · limited daily corporate access',
      'AACSB "member" not accredited — TAPMI and GLIM have full AACSB+AMBA Double Crown',
      'Bottom-quartile General PGDM outcomes ₹9-12 LPA per student reviews',
    ],
    asked: ['GIM Goa vs IMT Ghaziabad', 'GIM Goa BDA placement 2025', 'GIM Goa Healthcare Management programme', 'Is GIM Goa worth ₹21.45L?', 'GIM Goa scholarship eligibility'],
  },
...
export function findCollege(query) {
  ...
  const aliases = {
    ...
    'gim': 'gim-goa', 'gim goa': 'gim-goa', 'goa institute': 'gim-goa', 'goa institute of management': 'gim-goa',
    'soil': 'soil-gurgaon',
